...
public class ItemSalesReport1  implements Serializable {

    @SerializedName("success")
    String successstr;

    @SerializedName("returnds")
    ArrayList<ItemSalesarray> itembeanarr;

    public ArrayList<ItemSalesarray> getItembeanarr() {
        return itembeanarr;
    }

    public void setItembeanarr(ArrayList<ItemSalesarray> itembeanarr) {
    ...
    public static class   ItemSalesarray implements  Serializable
    {
