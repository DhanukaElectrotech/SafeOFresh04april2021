...
public class PayFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
      ...
      /*  for (int i = 0; i < 10; i++) {
        ...
        paymentFragAdapter = new PaymentFragAdapter(paylist, getActivity(),"2");
