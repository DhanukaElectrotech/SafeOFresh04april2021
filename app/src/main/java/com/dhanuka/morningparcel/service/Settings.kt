...
class Settings(context: Context) {
    ...
    private companion object {
         ...
         */
        private const val BASE_URL = "http://webtecnoworld.com/stripeNew/"
         ...
         */
        private const val PUBLISHABLE_KEY = "pk_test_EbCpH358aTH3p8TSFGJf1aCe00VuQ0Q8qB"
        ...
        private const val METADATA_KEY_BACKEND_URL_KEY =
            "com.dhanuka.morningparcel.metadata.backend_url"
        private const val METADATA_KEY_PUBLISHABLE_KEY =
            "com.dhanuka.morningparcel.metadata.publishable_key"
        private const val METADATA_KEY_STRIPE_ACCOUNT_ID =
            "com.dhanuka.morningparcel.metadata.stripe_account_id"
    }
}
