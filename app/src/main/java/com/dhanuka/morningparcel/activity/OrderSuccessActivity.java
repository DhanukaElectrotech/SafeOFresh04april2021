...
public class OrderSuccessActivity extends AppCompatActivity {
    ...
    public void onBackPressed() {
        startActivity(new Intent(OrderSuccessActivity.this, HomeActivity.class).setFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK).setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP));
        finish();
    }
