...
import com.dhanuka.morningparcel.activity.ChangePass;
import com.dhanuka.morningparcel.activity.ComplaintReason;
...
import com.dhanuka.morningparcel.activity.OrderHistoryActvitylsp;
import com.dhanuka.morningparcel.activity.PastOrderItem;
import com.dhanuka.morningparcel.activity.PromotionSelector;
import com.dhanuka.morningparcel.activity.Reach_Us;
import com.dhanuka.morningparcel.activity.RefernEarn;
import com.dhanuka.morningparcel.activity.RewardPoints;
import com.dhanuka.morningparcel.activity.StartActivityNew;
import com.dhanuka.morningparcel.activity.UpdateProfile;
        ...
        imgback.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (new Preferencehelper(BaseActivity.this).getPrefsUsercategory().equalsIgnoreCase("1057")) {
                    startActivity(new Intent(getApplicationContext(), SupplierHomeActivity.class).addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK));
                }
                finish();
            }
        });
            ...
            case R.id.home_nav:
                ...
                if (prefs1.getString("cntry", "India").equalsIgnoreCase("India")) {
                    ...
                    if (!prefs.getPrefsUsercategory().equalsIgnoreCase("1057")) {
                        ...
                        startActivity(new Intent(BaseActivity.this, SupplierHomeActivity.class));
