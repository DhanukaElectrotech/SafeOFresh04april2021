...
import com.dhanuka.morningparcel.activity.supplierorder.adapter.ProductsAdapter;
...
public class ProductFragment extends Fragment implements onAddCartListener, OnItemFilterListener {
    ...
    private com.dhanuka.morningparcel.activity.supplierorder.adapter.ProductsAdapter adapter;
...
*/
    ...
    public void loadLocal(String resp) {
        ...
        try {
            ...
            adapter = new com.dhanuka.morningparcel.activity.supplierorder.adapter.ProductsAdapter(context, masterlist, this);
...
//                dbManager.update(cartProduct);
    ...
    public void onFilterClick(ChildCatBean mChildCatBean) {
        ...
        if (mChildCatBean.getGroupId().equalsIgnoreCase("0000")) {
            ...
            adapter = new com.dhanuka.morningparcel.activity.supplierorder.adapter.ProductsAdapter(context, mListFilteredItems, this);
            lvProducts.setAdapter(adapter);
            lvProducts.setVisibility(View.VISIBLE);
