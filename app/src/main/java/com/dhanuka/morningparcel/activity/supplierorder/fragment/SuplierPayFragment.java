...
import com.dhanuka.morningparcel.adapter.PaymentFragAdapter;
import com.dhanuka.morningparcel.beans.FancyToast;
import com.dhanuka.morningparcel.utils.JKHelper;

public class SuplierPayFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    PaymentFragAdapter paymentFragAdapter;
    ...
    public static SuplierPayFragment newInstance(String param1, String param2) {
        SuplierPayFragment fragment = new SuplierPayFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        paycontainer.setLayoutManager(new LinearLayoutManager(getActivity().getApplicationContext(), RecyclerView.VERTICAL, false));
      ...
      /*  for (int i = 0; i < 10; i++) {
            ...
            payfraghelper.setPaymentamount(getActivity().getString(R.string.strpayfrag));
        ...
        paymentFragAdapter = new PaymentFragAdapter(paylist, getActivity(),"1");
        paycontainer.setAdapter(paymentFragAdapter);
        ...
        StringRequest postRequest = new StringRequest(Request.Method.POST, getString(R.string.URL_BASE_URL),
            ...
            protected Map<String, String> getParams() {
                ...
                try {
                    ...
                    String param = getString(R.string.GET_WALLET_DETAIL) + "&contactid=" + isCustomer + "&strdt=" + mStartDate.replace("/", "-") + "&enddt=" + mTodayDate.replace("/", "-");
