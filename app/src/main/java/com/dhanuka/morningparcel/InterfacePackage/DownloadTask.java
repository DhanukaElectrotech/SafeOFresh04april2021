            ...
            try {
                if (outputFile != null) {
                    progressDialog.dismiss();
                      pdfFile = new File(Environment.getExternalStorageDirectory() + "/SafeOKart/" + downloadFileName);  // -> filename = maven.pdf
                    Uri path = Uri.fromFile(pdfFile);
                    PDFView.with(mActriity)
        ...
        protected Void doInBackground(Void... arg0) {
            try {
                ...
                if (new CheckForSDCard().isSDCardPresent()) {
                    ...
                    apkStorage = new File(Environment.getExternalStorageDirectory() + "/" + "Safe'O'Fresh");
                } else
